...
- Status: `review` hard=`0` warning=`14` files=`570`
- Policy: min-lines=`10` min-tokens=`100` max-findings=`50` include-tests=`false` strict=`false`
- Duplicate volume: lines=`56` tokens=`172` bytes=`1699`
...
| `ExactUnitSameName` | `Warning` | `typescript` | 13 | 31 | `packages/jekko/src/cli/cmd/tui/context/capability.ts:218-231, packages/jekko/src/cli/cmd/tui/context/jankurai-baseline.ts:99-112` | `same-name semantic unit copied across multiple files` |
| `ExactUnitDifferentName` | `Warning` | `typescript` | 2 | 9 | `packages/jekko/src/cli/cmd/debug/agent.ts:116-118, packages/jekko/src/cli/cmd/tui/context/capability.ts:50-52, packages/jekko/src/cli/cmd/tui/context/jankurai-baseline.ts:40-42, packages/jekko/src/cli/cmd/tui/context/jankurai-history.ts:65-67, packages/jekko/src/cli/cmd/tui/routes/session/session-body-core-support.ts:12-14` | `same body appears under different names across files` |
...
| `ExactUnitSameName` | `Warning` | `typescript` | 2 | 9 | `packages/jekko/src/cli/cmd/tui/context/capability.ts:50-52, packages/jekko/src/cli/cmd/tui/context/jankurai-baseline.ts:40-42, packages/jekko/src/cli/cmd/tui/context/jankurai-history.ts:65-67` | `same-name semantic unit copied across multiple files` |
...
| `ExactUnitSameName` | `Warning` | `typescript` | 2 | 9 | `packages/jekko/src/cli/cmd/debug/agent.ts:116-118, packages/jekko/src/cli/cmd/tui/routes/session/session-body-core-support.ts:12-14` | `same-name semantic unit copied across multiple files` |
...
| Jankurai tool adoption and CI replacement | 7 | 29 | 2.03 | control-plane files present; applicable=17 |
...
- Artifact counts: `none`
- Artifact fingerprints: `0`
...
- Accessibility violations / incomplete / passes: `0` / `0` / `0`
