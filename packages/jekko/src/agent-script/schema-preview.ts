...
import { ZYAL_TOP_LEVEL_KEYS } from "./schema-spec"
...
export const ZyalPreview = Schema.Struct({
  ...
  research_paper_scan_summary: Schema.optional(Schema.String),
  research_full_text_summary: Schema.optional(Schema.String),
  research_dedupe_summary: Schema.optional(Schema.String),
  research_context_packing_summary: Schema.optional(Schema.String),
  research_question_bank_summary: Schema.optional(Schema.String),
  research_agent_trials_summary: Schema.optional(Schema.String),
  research_audit_summary: Schema.optional(Schema.String),
  jankurai_enabled: Schema.Boolean,
  jankurai_summary: Schema.optional(Schema.String),
  jankurai_task_source: Schema.optional(Schema.String),
  jankurai_max_risk: Schema.optional(Schema.String),
...
export function assertZyalTopLevelKeys(input: Record<string, unknown>) {
  const allowed = new Set(ZYAL_TOP_LEVEL_KEYS)
